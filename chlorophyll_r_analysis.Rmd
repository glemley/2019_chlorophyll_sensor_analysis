...
ggplot(data = lab.field.join2, aes(x = Chl_ugL, y = result_value), size = 3) +
  ...
  xlab("YSI TA Chl ug/L") +
  ylab("Extracted chl ug/L") +
  ggtitle("YSI TA Sensor vs Lab-extracted Chl-a (filtered)")
...
ggplot(data = lab.field.join.noextremes.equip, aes(x = Chl_ugL, y = result_value), size = 3) +
  ...
  xlab("YSI TA Chl ug/L") +
  ylab("Extracted chl ug/L") +
  facet_wrap(~EQUIP_USED, ncol = 5, scales = "free")
...
ggplot(data = lab.field.join, aes(x = Chl_ugL, y = result_value), size = 3) +
  ...
  xlab("YSI TA Chl ug/L") +
  ylab("Extracted chl ug/L") +
  facet_wrap(~Project, ncol = 5, scales = "free") 
...
# Why does the plot below omit data??? Only sets manual axis limits from above.
...
ggplot(data = lab.field.join.landuse, aes(x = Chl_ugL, y = result_value), size = 3) +
  geom_point(shape = 19, size = 2, aes(color = LANDUSE)) +
  geom_smooth(method=lm) +
  geom_abline(aes(intercept=0, slope=1)) +
  xlab("YSI TA Chl ug/L") +
  ylab("Extracted chl ug/L") +
  facet_wrap(~LANDUSE, ncol = 5, scales = "free") 

ggplot(data = lab.field.join.noextremes.landuse, aes(x = Chl_ugL, y = result_value), size = 3) +
  geom_point(shape = 19, size = 2, aes(color = LANDUSE)) +
  geom_smooth(method=lm) +
  geom_abline(aes(intercept=0, slope=1)) +
  xlab("YSI TA Chl ug/L") +
...
ggplot(data = lab.field.join.nooutliers.landuse, aes(x = Chl_ugL, y = result_value), size = 3) +
  geom_point(shape = 19, size = 2, aes(color = LANDUSE)) +
  # scale_color_manual(values=as.vector(alphabet2(11))) +
  geom_smooth(method=lm) +
  geom_abline(aes(intercept=0, slope=1)) +
